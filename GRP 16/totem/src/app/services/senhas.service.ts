...
export class SenhasService {
  ...
  somaExame() {
   ...
   novaSenha(tipoSenha:string=''){
    if(tipoSenha=='SG'){
      this.somaGeral();
      const numeroSenha = this.senhasArray['SG'].length + 1;
      this.inputNovaSenha=
        ...
        '-'+
        tipoSenha+
        numeroSenha.toString().padStart(2, '0');       
      this.senhasArray['SG'].push(this.inputNovaSenha);
    } else if(tipoSenha=='SP'){
      this.somaPrior();
      const numeroSenha = this.senhasArray['SP'].length + 1;
      this.inputNovaSenha=
      new Date().getFullYear().toString().substring(2,4)+
      (new Date().getMonth()+1).toString().padStart(2,'0')+
      new Date().getDay().toString().padStart(2,'0')+
      ...
      this.somaExame();
      const numeroSenha = this.senhasArray['SE'].length + 1;
      this.inputNovaSenha=
      new Date().getFullYear().toString().substring(2,4)+
        (new Date().getMonth()+1).toString().padStart(2,'0')+
        new Date().getDay().toString().padStart(2,'0')+
