...
export class Tab2Page {
    ...
    getPokemonAdv() {
        this.pokeAPIService.getPokeAPIService().subscribe((value) => {
            ...
            this.pokemonAdv.habilidades = JSON.parse(JSON.stringify(value))[
                "abilities"
            ].length;
            this.pokemonAdv.peso = JSON.parse(JSON.stringify(value))["weight"];
            this.pokemonAdv.altura = JSON.parse(JSON.stringify(value))[
                "height"
            ];
            this.pokemonAdv.img = JSON.parse(JSON.stringify(value))["sprites"][
                "other"
